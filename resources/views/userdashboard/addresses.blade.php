...
@endphp
  @if ($user->status === 'accepted')
                                ...
                                @else
                                 ...
                                 @endif
                        @else
                                <div class="card bg-warning text-dark" style="    border-radius: 0.375rem !important;
    top: 12rem;
    margin-left: 25rem;width: 26rem;">
                                    <div class="card-body" >
                                        ...
                                        @elseif ($user->status === 'rejected')
                                            <p class="card-text">Your profile has been rejected. Please contact support for more information.</p>
                                        @else
